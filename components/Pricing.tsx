...
export function Pricing({}: PricingProps) {
  const deliverables = [
    ...
    },
    {
      icon: Sparkles,
      title: "2026年7月押题预测单",
      desc: "高/中押中概率语法预测、文字词汇/读解/听力预测、考前1晚必背20条、必错陷阱点TOP20",
    },
    {
      icon: BookText,
      title: "高频词汇表 + 增值资料包",
  ...
  const trustModules = [
    ...
    },
    {
      icon: RefreshCw,
      title: "更新说明",
      desc: "押题预测等时效性内容持续更新至 2026 年 7 月考前。词汇库、语法库等随资料完善不定期增补。",
    },
    {
      icon: Shield,
      title: "退款政策",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#6B5E55] max-w-lg mx-auto text-sm leading-relaxed">
            不是经验帖，是<b>基于59套真题的有据可循</b>。一次买断，整整 1 套 N1 备考资产库：
          </p>
        </div>
        ...
        <div className="mt-14 max-w-xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                q: "资料会更新吗？",
                a: "会！购买后可持续获得更新，包括每次考试前的押题预测更新，直到 2026 年 7 月考前最后一天。",
              },
              {
                q: "买了可以分享给别人吗？",
                a: "仅供个人学习使用。你的资料会带有专属水印，感谢支持我们把真题分析继续做下去。",
              },
            ].map((faq, index) => (
              <details
                key={index}
