        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-[#6B5E55] text-sm leading-relaxed">
              基于18套完整真题（含题目+听力+解析）的频率分析系统，<br />助你高效冲刺合格。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="#preview" className="text-[#6B5E55] hover:text-[#C75B3B] transition-colors">资料预览</a></li>
              <li><a href="#pricing" className="text-[#6B5E55] hover:text-[#C75B3B] transition-colors">价格方案</a></li>
              <li><a href="/tool" className="text-[#6B5E55] hover:text-[#C75B3B] transition-colors">AI 备考工具</a></li>
              <li><a href="/download" className="text-[#6B5E55] hover:text-[#C75B3B] transition-colors">资料领取</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[#E8E0D5] pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-xs">
              <a href="/privacy" className="text-[#6B5E55]/60 hover:text-[#6B5E55] transition-colors flex items-center gap-1">
                <span>隐私政策</span>
                <ExternalLink className="w-3 h-3" />
              </a>
              <a href="/terms" className="text-[#6B5E55]/60 hover:text-[#6B5E55] transition-colors flex items-center gap-1">
                <span>服务条款</span>
                <ExternalLink className="w-3 h-3" />
              </a>
            </div>
