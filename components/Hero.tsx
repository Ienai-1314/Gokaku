        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="font-noto-jp text-2xl md:text-3xl text-[#6B5E55] mt-2 leading-relaxed">
              量化 <span className="text-[#C75B3B] font-bold">{activeLevel}</span> · 把18套真题变成你的备考捷径
            </div>
          </motion.div>
          ...
          >
            逐题统计 <span className="text-[#2D2420] font-semibold">18套含题目+听力+解析的完整真题</span>，
            建立语法频率排序和轮空周期参考表。
            不是经验帖，是数据结论。¥39 早鸟价，5月起恢复¥49。
          </motion.p>
