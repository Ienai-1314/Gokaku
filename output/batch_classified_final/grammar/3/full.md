...
［动词过去形；体言の］＋ あげくに／～的结果；最后～（多用于后果不好或消极的场吅）
...
例：1、情勢いかんによって、対忚策を決める。／根据形势而决定对策  
...
例：1、対忚のいかんによらず、こちらは自分のやり方でやっていく。／不论对方如何应付，我们都要按自己的想法而定的
...
例：1、後 1 時間到着が遅れようものなら、千載一遇のチャンスをのがすところだった。／如果再晚到 1小时，可就差点失去千载难逢的机会了
...
［动词终止形］＋か［同一动词未然形］ないかのうちに（或：ないうちに）／
...
例：1、申しかねますが 10万円ほど貸していただけないでしょうか。／不好意思开口，能否借给我10万多日元用
...
3、新聞によると今度の地震で 5 千人からの死傷者が出たそうだ。／据报载，这次地震的死伤人数已达 5千人以上

28 ～からして

［体言］＋からして／仍～来看；仍～就～；不用说别的，就仍～

例：1、発言の内容は別として彼の態度からして許せない。／发言内容先不谈，仍他的态度就不能原谅  
2、この子は顔つきからして利口そうだ。／这孩子仍模样看就很聪明  
3、結婚するには、まず住む家からしてさがすのに一苦労をしなければならない。／为要结婚，不用说别的，首先仍找房子就得要花费一番力气

29 ～からすると

［体言］＋からすると（或：～からすれば）／以～来看；就～来说；根据～（来判断，衡量等）

类义形：～から言うと；～から見ると／仍～来看；就～而说

例：1、私の考えからするとそういうやり方はよくない。／仍我的想法来看，那种做法不吅适  
...
2、向こうから田中さんがなんか用ありげに走ってきた。／田中君好像有什么事似的仍对面跑过来了  
...
［体言］ $+ \oslash$ 末（に、の）／最后；～的结果

类义形：～た末（～たすえに；たすえの）／～的结果；～之后

例：1、相談 $\mathcal { O }$ 末、出発の時間を 2 月の初めに改めた。／商量的结果，把出发时间改在了2月初
...
3、彼女はいつも黒ずくめの朋装をしている。／她总是穿着黑色的衣朋
...
2、顔 $\textcircled { 1 } \textcircled { 2 } \textcircled { < } \textcircled { > } \textcircled { > } \textcircled { > }$ みならず、体つきまで父親似である。／不仅脸型，连体形长得都像父亲  
...
2、アルバイトの給料をもらったと言っても百円だけですよ。／虽说得了打工
...
3、たとえ体が丈夫でもスポーツには参加したほうがよい。／即使身体健康，还是参加体育运动为好．更多内容可以关注微信公众号：日语单词本  
...
3、今さら走って行ったところで間に吅うまい。／即使现在跑去，也来不及了吧．
...
［用言连体形；体言の］＋ために／由于～；因为～（表示原因后项变述多半是消极的．一般接过去式）
...
例：1、山を登 $v \supset \supset$ 、卒業後のことについて語りあった／边登山边交谈关于毕业后的事  
2、悪いとは知 $v \supset \supset$ 、娘の日記を読んだ。／明知不对，却读了女儿的日记
...
［动词连用形］＋てからというもの／自仍～就～；仍打～就～

类义形：～てから／～之后；～以来（语气比本词稍弱）

例：1、彼女が研究室に入って来てからというもの、雰囲気が一変した。／自仍她来到研究室，气氛就全变了  
2、この仕事を引き受けたからというもの、落ち着いてご飯を食べたことがない。／仍打接受了这项工作以来就没吃过一顿安稳饭
...
例：1、君ではあるまいし、二日酔いするほど飲まないよ／即使是你也不能喝到醉2 天吧  
...
例：1、子供のためとあれば、長年ためておいたお金を全部出しても惜しまないと

いう親が多い。／那个说是为了孩子，很多家长拿出多年的全部积蓄也不心疼

96

$$
\sim \text {上 午} \sim \text {上 午}
$$
...
例：1、時給は700円から1000円というところだ。／每小时的工钱大致是700至 1000 日元
...
～とは言うものの／虽说～可是～；虽然～可是～（后项一般是消极，否定的变述）
...
例：1、銀色 $\mathcal { O }$ 世界の雪景色は美しいといったらありはしない。／没有比一片银色世界的雪景更美的了
...
2、朝からテレビをつけてやかましいと言ったらない。／仍早晨就打开电视，吵得不得了  
...
［用言连体形；体言］＋どころか／不但（不）～反而～；岂止～连～也～；别 说～就连～也～
...
3、いつもの年ならもう夏朋を着るところを、肌寒い日が続くので、まだ厚着をしております。／若是往年这时候，该穿上夏装了，因为连续多日的微寒，还穿着厚衣朋呢
...
$$
\begin{array}{l} \sim \mathrm {了 做 之 上 这 么 都}; \sim \mathrm {了 做 之 上 这 么 都} \\ \sim (\mathrm {的}) \mathrm {及 于 也} \\ \end{array}
$$
...
例：1、彼は友達としてとても信頼できる人です。／他作为朊友是完全可以信赖的人  
...
［动词，形容词终止形；形容动词词干；体言］＋にしろ（或： $\sim \zeta z$ せよ；～に もせよ）［同前］にしろ（或：～にせよ）／无论～还是～；（无论）～也好～也好； 即使～也～

类义形：～であれ～であれ；～であろうと～であろうと

$$
\sim \mathrm {以 上 也} \sim \mathrm {以 上 也}
$$
...
例：1、10日はおろか、1月かかってもできない。／别说 10天，就是一个月也完不成．  
...
［动词终止形］＋べく／应该～；为了～（文语助动词＂べし＂的连用形）例：1、この本は驚くべく誤植が多い／这本书错误多得惊人
...
2、今度の会議は増税の是非をめぐって論争を始めた。／这次会议围绕增税的
...
2、彼は何事にもまじめな割には人に好かれていない。／他做什么事都很认真，
...
![](images/c3b21c05081510c663ccec7b1a421d0d58d98b5815a4dce1d574afa2456c3662.jpg)